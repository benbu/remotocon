 ...
 * Original file: C:\\ben\\svn\\beanstalk\\remotocon\\trunk\\Plugins\\RemotoFileManager\\mobile\\src\\com\\remotocon\\aidl\\IRemotoconService.aidl
 */
...
/**
 * Cast an IBinder object into an com.remotocon.aidl.IRemotoconService interface,
...
static final int TRANSACTION_remoteProcedureCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_checkServerPluginExists = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_installServerPlugin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
}
public byte[] remoteProcedureCall(java.lang.String objectName, java.lang.String methodName, byte[] objectArray) throws android.os.RemoteException;
public boolean checkServerPluginExists(java.lang.String packageName, java.lang.String version) throws android.os.RemoteException;
public boolean installServerPlugin(java.lang.String dllURL, java.lang.String dllName) throws android.os.RemoteException;
